...
<div class="exmaple">
    <div class="s-swiper js__swiper-one-item">
        ...
        <div class="swiper-wrapper">
            <div class="g-fullheight--xs g-bg-position--center swiper-slide" style="background: url('img/assets/pl.jpg');">
                <div class="container g-text-center--xs g-ver-center--xs">
                    <div class="g-margin-b-30--xs">
                        <h1 class="g-font-size-35--xs g-font-size-45--sm g-font-size-55--md g-color--white">
                    </div>
                    {{-- <iframe width="664" height="374" src="https://www.youtube.com/embed/TaETGTnEZSs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> --}}
                    {{-- <iframe width="853" height="480" src="https://www.youtube.com/embed/TaETGTnEZSs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> --}}
                    <a class="js__popup__youtube" href="video/SMK-AB.mp4" title="Intro SMK AB">
...
<div class="example">
    <!-- Features -->
    <div id="js__scroll-to-section" class="example container g-padding-y-80--xs g-padding-y-125--sm">
...
@section('parallax')
    <!-- Parallax -->
    <div class="example js__parallax-window" style="background: url(img/1920x1080/03.jpg) 50% 0 no-repeat fixed;">
...
@section('culture')
    ...
    <div class="g-promo-section">
        <div class="example container g-padding-y-80--xs g-padding-y-125--sm">
            <div class="row">
...
@section('subscribe')
    <!-- Subscribe -->
    <div class="example js__parallax-window" style="background: url(img/1920x1080/07.jpg) 50% 0 no-repeat fixed;">
...
@section('portofolio')
    <!-- Portfolio Filter -->
    <div class="example container g-padding-y-80--xs">
...
@section('portofolio-gallery')
    <!-- Portfolio Gallery -->
    <div class="example container g-margin-b-100--xs">
...
@section('testimonials')
    <!-- Testimonials -->
    <div class="example js__parallax-window" style="background: url(img/1920x1080/04.jpg) 50% 0 no-repeat fixed;">
        <div class="container g-text-center--xs g-padding-y-80--xs g-padding-y-125--sm">
...
@section('clients')
<div class="example g-bg-color--sky-light">
...
@section('counter')
<div class="example js__parallax-window" style="background: url(img/1920x1080/06.jpg) 50% 0 no-repeat fixed;">
...
@section('google-map')
    <section class="example s-google-map">
        <div class="map-responsive">
            <iframe class="google-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.6974215375512!2d106.91398791477287!3d-6.926725294995261!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6849d3ec9010fd%3A0x6d55c66675111255!2sSMK%20AB%20International!5e0!3m2!1sid!2sid!4v1591541513741!5m2!1sid!2sid"  frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
        </div>
    </section>
@endsection

@section('footer')
<footer class="example g-bg-color--dark">
    <!-- Links -->
