            ...
            <div class="s-header__navbar-row">
                <div class="s-header__navbar-row-col">
                    ...
                    <div class="s-header__logo">
                        <a href="/" class="s-header__logo-link h1 text-primary">
                            <img  class="d-inline-block align-top" src="{{ asset('') }}img/assets/logo.png" alt="Megakit Logo">&ensp;SMK AB International
                            {{-- <img class="s-header__logo-img s-header__logo-img-shrink" src="{{ asset('') }}img/assets/logo.png" alt="Megakit Logo"> --}}
                        </a>
                    </div>
                    <!-- End Logo -->
                </div>
